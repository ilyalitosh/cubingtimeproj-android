package com.litosh.ilya.cubingtimeproj.chatactivity.models.adapters;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ChatMessagesData.MESSAGE_OTHER_USER) {
            view = mLayoutInflater.inflate(
                    R.layout.activity_chat_room_message_item_other_user,
                    parent,
                    false);
            return new MessagesOtherUserViewHolder(view);
        } else if (viewType == ChatMessagesData.MESSAGE_ME) {
            view = mLayoutInflater.inflate(
                    R.layout.activity_chat_room_message_item_me,
                    parent,
                    false);
